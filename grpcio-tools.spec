...
Source0  : https://files.pythonhosted.org/packages/11/de/449bdcfa04227617631dda9de4c2d668bf5854e439aa41f04a8cdd7aab5f/grpcio-tools-1.39.0.tar.gz
...
%prep
%setup -q -n grpcio-tools-1.39.0
cd %{_builddir}/grpcio-tools-1.39.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626966393
